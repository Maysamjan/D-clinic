...
class ReportsPage(QScrollArea):
    def __init__(self, parent=None):
        ...
        self.range_combo.addItem(t("۶ ماه اخیر"), 6)
        self.range_combo.addItem(t("۱۲ ماه اخیر"), 12)
        ...
        root.addWidget(self._card(t("درآمد ماهانه"), self.revenue_chart))

        self.growth_chart = BarChart(color=QColor("#0891B2"))
        root.addWidget(self._card(t("رشد مریض‌ها (ثبت‌نام ماهانه)"), self.growth_chart))

        self.treatments_chart = HBarChart(color=QColor("#6366F1"))
        root.addWidget(self._card(t("رایج‌ترین معالجات"), self.treatments_chart))
