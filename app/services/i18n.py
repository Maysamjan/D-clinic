...
_EN: dict[str, str] = {
    ...
    "وضعیت دندان": "Tooth status",
    "فک بالا": "Upper jaw",
    "فک پایین": "Lower jaw",
    "روی هر دندان کلیک کنید تا وضعیت آن را ثبت کنید.": "Click a tooth to record its condition.",
    "سالم": "Healthy",
    "پوسیدگی": "Caries",
    "ترمیم‌شده": "Filled",
    "عصب‌کشی": "Root canal",
    ...
    "کشیده‌شده": "Extracted",
    "غایب": "Missing",
    "برای ویرایش، روی نسخه دوبار کلیک کنید.": "Double-click a prescription to edit.",
    "ویرایش نسخه": "Edit prescription",
    "نسخه‌ی جدید": "New prescription",
